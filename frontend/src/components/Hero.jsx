...
function Hero({ profile, researchAreas, publicationsCount, certificationsCount }) {
      ...
      >
        <div className="grid items-center gap-8 lg:grid-cols-2 lg:gap-12">
          <motion.div variants={fadeUp}>
            ...
            <p className="mt-4 text-lg font-medium text-gray-700 sm:text-xl">{profile.subtitle}</p>
            ...
            <motion.div className="mt-5 flex flex-wrap gap-4 text-sm" variants={staggerContainer} initial="hidden" whileInView="visible" viewport={{ once: true }}>
              <motion.a
          ...
          <motion.div className="mx-auto w-full max-w-md lg:ml-auto lg:mr-0" variants={fadeUp}>
            <motion.div
        ...
        <motion.div
          ...
          variants={fadeUp}
        >
          <h2 className="text-lg font-semibold text-gray-900">Research Interests</h2>
