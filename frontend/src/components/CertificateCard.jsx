...
function CertificateCard({ certificate }) {
  ...
  const isImage = lowerPath.endsWith('.jpg') || lowerPath.endsWith('.png') || lowerPath.endsWith('.jpeg')
  ...
  return (
    <>
      ...
      >
        ...
        <div className="p-4">
          <h3 className="text-sm font-semibold leading-snug text-gray-900">{certificate.title}</h3>
      ...
      {open && (
        ...
        >
          ...
          >
            ...
            {isImage ? (
              <img src={certificate.file} alt={certificate.title} className="h-auto w-full rounded-l rounded-lg" />
            ) : (
              <iframe src={certificate.file} title={certificate.title} className="h-96 w-full rounded-lg" />
            )}
          </motion.div>
        </motion.div>
      )}
